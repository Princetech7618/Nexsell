...
// Sample 20 mobiles data with category and brand
const mobilesData = [
  {
    id: 1,
...
/>
    ...
    <main className="bg-white min-h-screen py-10 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto font-serif">
      <h1 className="text-5xl mt-5 font-serif text-indigo-600 mb-8 text-center">
        ...
        >
          ...
          <div className="overflow-hidden">
            <img
              src={mobile.img}
              alt={mobile.title}
              className="w-full h-52 sm:h-56 object-cover transition-transform duration-700 
          ...
          <div className="p-5">
            {/* TITLE */}
            <h2 className="text-lg font-semibold text-gray-800 line-clamp-1 group-hover:text-indigo-800 transition">
              {mobile.title}
            </h2>
            ...
            {/* TAGS */}
            <div className="mt-3 flex flex-wrap gap-2 text font-md medium">
    ...
    <p className="text-center col-span-full text-gray-500 text-lg">
      ...
      <section className="mt-16 bg-gradient-to-r from-indigo-50 to-white rounded-3xl p-10 text-center shadow-lg max-w-4xl mx-auto">
        ...
        <p className="text-gray-700 max-w-3xl mx-auto leading-relaxed text-lg">
          Nexsell is your trusted platform to buy and sell mobile phones with confidence. Our
          verified listings, advanced filters, and seamless experience ensure you find the perfect
          mobile device, while offering a safe marketplace for buyers and sellers across India.
        </p>
      </section>

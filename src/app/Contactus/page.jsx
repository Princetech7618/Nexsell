...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-16 px-4 sm:px-6 lg:px-20">
      ...
      >
        <h1 className="text-5xl font-serif-bold text-indigo-600 mb-4">
          Contact NexSell
        </h1>
      ...
      <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <input
              ...
              required
              className="w-full p-4 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all"
            />
            <input
              type="email"
              name="email"
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              type="submit"
              className="bg-indigo-600 hover:bg-indigo-700 text-white font-semibold px-8 py-4 rounded-full shadow-lg transition-all duration-300 mt-4"
            >
              Send Message
            </motion.button>
          </form>
        ...
        >
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-200 hover:shadow-2xl transition-all">
            <h3 className="text-2xl font-bold mb-4 text-gray-900">Our Office</h3>
            <p className="text-gray-700 mb-2">NexSell HQ</p>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-200 hover:shadow-2xl transition-all">
            ...
            <p className="text-gray-700 mb-2">Email: support@nexsell.com</p>
            <p className="text-gray-700 mb-2">Live Chat: Available 9 AM - 9 PM IST</p>
      ...
      >
        ...
        <div className="w-full h-96 rounded-2xl overflow-hidden shadow-lg border border-gray-200 hover:shadow-2xl transition-all">
          <iframe
      ...
      {/* Footer CTA - Call Support with Dynamic Effect */}
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        ...
        {!calling ? (
          ...
          <motion.div
            ...
            className="inline-block bg-green-500 text-white font-semibold px-8 py-3 rounded-full shadow-lg transition-all duration-300 flex items-center justify-center gap-3"
          >

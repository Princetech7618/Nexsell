...
//       "https://images.pexels.com/photos/17692741/pexels-photo-17692741.jpeg",
//       "https://images.pexels.com/photos/17692743/pexels-photo-17692743.jpeg",
...
//       "https://images.pexels.com/photos/1287564/pexels-photo-1287564.jpeg"
//     ],
//     postedOn: "2024-12-01",
//   },
...
//   },
// ];
// // Your featuredAds data here (same as before)
...
//   const { id } = params || {}; // id is a string from URL param
...
//         <h2 className="text-2xl font-semibold mb-6 text-red-600">Item not found</h2>
...
//  return (
//   <div className="min-h-screen bg-gray-100 flex justify-center items-center p-4 pt-24">
//     <motion.div
//       initial={{ opacity: 0, scale: 0.95 }}
//       animate={{ opacity: 1, scale: 1 }}
//       transition={{ duration: 0.5 }}
//       className="bg-white shadow-lg rounded-2xl max-w-5xl w-full md:flex overflow-hidden"
//     >
...
// className="text-start text-indigo-600 cursor-pointer mb-4 ">
//  {"<"} Back
// </button>
//         {/* Title + Price */}
...
//           {/* <button className="px-5 py-2 border border-indigo-600 text-indigo-600 rounded-lg hover:bg-indigo-50 transition">
//             Save Ad
//           </button> */}
